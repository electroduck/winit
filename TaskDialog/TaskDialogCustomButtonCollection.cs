...
namespace KPreisser.UI
{
    ...
    public class TaskDialogCustomButtonCollection
        : Collection<TaskDialogCustomButton>, ICollection<TaskDialogButton>
    {
        ...
        public void Add(TaskDialogButton item) {
            base.Add((TaskDialogCustomButton)item);
        }

        public bool Contains(TaskDialogButton item) {
            return base.Contains((TaskDialogCustomButton)item);
        }

        public void CopyTo(TaskDialogButton[] array, int arrayIndex) {
            base.CopyTo((TaskDialogCustomButton[])array, arrayIndex);
        }

        public bool Remove(TaskDialogButton item) {
            return base.Remove((TaskDialogCustomButton)item);
        }
