...
namespace KPreisser.UI
{
    ...
    public class TaskDialogStandardButtonCollection
        : KeyedCollection<TaskDialogResult, TaskDialogStandardButton>, ICollection<TaskDialogButton>
    {
        ...
        public void Add(TaskDialogButton item) {
            base.Add((TaskDialogStandardButton)item);
        }

        public bool Contains(TaskDialogButton item) {
            return base.Contains((TaskDialogStandardButton)item);
        }

        public void CopyTo(TaskDialogButton[] array, int arrayIndex) {
            base.CopyTo((TaskDialogStandardButton[])array, arrayIndex);
        }

        public bool Remove(TaskDialogButton item) {
            return base.Remove((TaskDialogStandardButton)item);
        }

        IEnumerator<TaskDialogButton> IEnumerable<TaskDialogButton>.GetEnumerator() {
            return (IEnumerator<TaskDialogButton>)base.GetEnumerator();
        }
    }
}
