...
namespace KPreisser.UI
{
...
#endif
    {
        ...
        private int _buttonClickNavigationCounter_stackCount;
        private int _buttonClickNavigationCounter_navigationIndex;
        ...
        /// </remarks>
        private TaskDialogButton _resultButton_button;
        private int _resultButton_buttonID;
        ...
        public TaskDialogButton Show(IntPtr hwndOwner)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (resultButtonID == _resultButton_buttonID)
                        return _resultButton_button;
                    else
                ...
                finally
                {
                    ...
                    _resultButton_button = null;
                    _resultButton_buttonID = 0;
                ...
                IntPtr lParam)
        {
            ...
            switch (notification)
            {
                ...
                case TaskDialogNotification.TDN_NAVIGATED:
                    ...
                    _buttonClickNavigationCounter_navigationIndex =
                            _buttonClickNavigationCounter_stackCount;
                ...
                case TaskDialogNotification.TDN_BUTTON_CLICKED:
                    ...
                    if (button != null && !_suppressButtonClickedEvent)
                    {
                        ...
                        try
                        {
                            ...
                            // as results).
                            if (_buttonClickNavigationCounter_navigationIndex >=
                                    _buttonClickNavigationCounter_stackCount)
                                handlerResult = false;
                        }
                        finally
                        {
                            _buttonClickNavigationCounter_stackCount--;
                            _buttonClickNavigationCounter_navigationIndex = Math.Min(
                                    _buttonClickNavigationCounter_navigationIndex,
                                    _buttonClickNavigationCounter_stackCount);
                        }
                    }
                    ...
                    if (handlerResult && IsTaskDialogButtonCommitting(button))
                    {
                        ...
                        else
                        {
                            ...
                            if (handlerResult) {
                                ...
                                _resultButton_button = button;
                                _resultButton_buttonID = buttonID;
                            }
                        }
                    }
