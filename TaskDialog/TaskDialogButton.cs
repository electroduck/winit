...
namespace KPreisser.UI
{
    ...
    public abstract class TaskDialogButton : TaskDialogControl
    {
        ...
        private ICollection<TaskDialogButton> _collection;
        ...
        protected ICollection<TaskDialogButton> Collection
        {
            get => _collection;
        ...
        protected override void ApplyInitializationCore()
        {
        ...
        protected void OnClick(TaskDialogButtonClickedEventArgs e)
        {
            Click?.Invoke(this, e);
        }
