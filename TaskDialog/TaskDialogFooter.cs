    ...
    public sealed class TaskDialogFooter : TaskDialogControl
    {
        ...
        public TaskDialogIcon Icon
        {
            ...
            set
            {
                ...
                var tupIcon = TaskDialogPage.GetIconValue(value);
        ...
        internal TaskDialogFlags Bind(TaskDialogPage page, out IntPtr footerIconValue)
        {
            ...
            footerIconValue = TaskDialogPage.GetIconValue(_icon).Item1;

            return result;
        }

        protected override TaskDialogFlags BindCore()
        {
            TaskDialogFlags flags = base.BindCore();

            _boundIconIsFromHandle = TaskDialogPage.GetIconValue(_icon).Item2
                    ?? false;
