...
namespace KPreisser.UI
{
    ...
    {
        private static readonly IDictionary<TaskDialogStandardIcon, TaskDialogStandardIconContainer> s_standardIcons
        ...
        {
            return new TaskDialogIconHandle(icon.Handle);
        }
#endif
