    ...
    public class TaskDialogPage
    {
        ...
        public TaskDialogIcon Icon
        {
            ...
            set
            {
                ...
                var tupIcon = GetIconValue(value);
                IntPtr iconValue = tupIcon.Item1;
                bool? iconIsFromHandle = tupIcon.Item2;
        ...
        internal static Tuple<IntPtr, bool?> GetIconValue(
                TaskDialogIcon icon)
        {
            IntPtr iconValue = IntPtr.Zero;
            ...
            return new Tuple<IntPtr, bool?>(iconValue, iconIsFromHandle);
        }
                ...
                out int defaultRadioButtonID)
        {
            ...
            var tupIcon = GetIconValue(_icon);
            IntPtr localIconValue = tupIcon.Item1;
            bool? iconIsFromHandle = tupIcon.Item2;
            iconValue = localIconValue;
            _boundIconIsFromHandle = iconIsFromHandle ?? false;
